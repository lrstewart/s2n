...
static s2n_result RESULT_ENSURE_NO_OVERFLOW_harness(uint64_t a, uint64_t b, uint64_t max)
{
...
static int POSIX_ENSURE_NO_OVERFLOW_harness(uint64_t a, uint64_t b, uint64_t max)
{
...
static const char* PTR_ENSURE_NO_OVERFLOW_harness(uint64_t a, uint64_t b, uint64_t max)
{
...
int main(int argc, char **argv)
{
    ...
    /* RESULT_ENSURE_NO_OVERFLOW(a, b, max) */
    EXPECT_OK(RESULT_ENSURE_NO_OVERFLOW_harness(0, 0, 0));
    EXPECT_OK(RESULT_ENSURE_NO_OVERFLOW_harness(0, 1, 1));
    EXPECT_OK(RESULT_ENSURE_NO_OVERFLOW_harness(1, 0, 1));
    EXPECT_OK(RESULT_ENSURE_NO_OVERFLOW_harness(1, 1, 2));
    EXPECT_OK(RESULT_ENSURE_NO_OVERFLOW_harness(UINT64_MAX, 0, UINT64_MAX));
    EXPECT_OK(RESULT_ENSURE_NO_OVERFLOW_harness(0, UINT64_MAX, UINT64_MAX));
    EXPECT_ERROR_WITH_ERRNO(RESULT_ENSURE_NO_OVERFLOW_harness(1, 1, 1), S2N_ERR_INTEGER_OVERFLOW);
    EXPECT_ERROR_WITH_ERRNO(RESULT_ENSURE_NO_OVERFLOW_harness(0, 2, 1), S2N_ERR_INTEGER_OVERFLOW);
    EXPECT_ERROR_WITH_ERRNO(RESULT_ENSURE_NO_OVERFLOW_harness(2, 0, 1), S2N_ERR_INTEGER_OVERFLOW);
    EXPECT_ERROR_WITH_ERRNO(RESULT_ENSURE_NO_OVERFLOW_harness(UINT64_MAX, 1, UINT64_MAX), S2N_ERR_INTEGER_OVERFLOW);
    EXPECT_ERROR_WITH_ERRNO(RESULT_ENSURE_NO_OVERFLOW_harness(1, UINT64_MAX, UINT64_MAX), S2N_ERR_INTEGER_OVERFLOW);
    ...
    /* POSIX_ENSURE_NO_OVERFLOW(a, b, max) */
    EXPECT_SUCCESS(POSIX_ENSURE_NO_OVERFLOW_harness(0, 0, 0));
    EXPECT_SUCCESS(POSIX_ENSURE_NO_OVERFLOW_harness(0, 1, 1));
    EXPECT_SUCCESS(POSIX_ENSURE_NO_OVERFLOW_harness(1, 0, 1));
    EXPECT_SUCCESS(POSIX_ENSURE_NO_OVERFLOW_harness(1, 1, 2));
    EXPECT_SUCCESS(POSIX_ENSURE_NO_OVERFLOW_harness(UINT64_MAX, 0, UINT64_MAX));
    EXPECT_SUCCESS(POSIX_ENSURE_NO_OVERFLOW_harness(0, UINT64_MAX, UINT64_MAX));
    EXPECT_FAILURE_WITH_ERRNO(POSIX_ENSURE_NO_OVERFLOW_harness(1, 1, 1), S2N_ERR_INTEGER_OVERFLOW);
    EXPECT_FAILURE_WITH_ERRNO(POSIX_ENSURE_NO_OVERFLOW_harness(0, 2, 1), S2N_ERR_INTEGER_OVERFLOW);
    EXPECT_FAILURE_WITH_ERRNO(POSIX_ENSURE_NO_OVERFLOW_harness(2, 0, 1), S2N_ERR_INTEGER_OVERFLOW);
    EXPECT_FAILURE_WITH_ERRNO(POSIX_ENSURE_NO_OVERFLOW_harness(UINT64_MAX, 1, UINT64_MAX), S2N_ERR_INTEGER_OVERFLOW);
    EXPECT_FAILURE_WITH_ERRNO(POSIX_ENSURE_NO_OVERFLOW_harness(1, UINT64_MAX, UINT64_MAX), S2N_ERR_INTEGER_OVERFLOW);
    ...
    /* PTR_ENSURE_NO_OVERFLOW(a, b, max) */
    EXPECT_NOT_NULL(PTR_ENSURE_NO_OVERFLOW_harness(0, 0, 0));
    EXPECT_NOT_NULL(PTR_ENSURE_NO_OVERFLOW_harness(0, 1, 1));
    EXPECT_NOT_NULL(PTR_ENSURE_NO_OVERFLOW_harness(1, 0, 1));
    EXPECT_NOT_NULL(PTR_ENSURE_NO_OVERFLOW_harness(1, 1, 2));
    EXPECT_NOT_NULL(PTR_ENSURE_NO_OVERFLOW_harness(UINT64_MAX, 0, UINT64_MAX));
    EXPECT_NOT_NULL(PTR_ENSURE_NO_OVERFLOW_harness(0, UINT64_MAX, UINT64_MAX));
    EXPECT_NULL_WITH_ERRNO(PTR_ENSURE_NO_OVERFLOW_harness(1, 1, 1), S2N_ERR_INTEGER_OVERFLOW);
    EXPECT_NULL_WITH_ERRNO(PTR_ENSURE_NO_OVERFLOW_harness(0, 2, 1), S2N_ERR_INTEGER_OVERFLOW);
    EXPECT_NULL_WITH_ERRNO(PTR_ENSURE_NO_OVERFLOW_harness(2, 0, 1), S2N_ERR_INTEGER_OVERFLOW);
    EXPECT_NULL_WITH_ERRNO(PTR_ENSURE_NO_OVERFLOW_harness(UINT64_MAX, 1, UINT64_MAX), S2N_ERR_INTEGER_OVERFLOW);
    EXPECT_NULL_WITH_ERRNO(PTR_ENSURE_NO_OVERFLOW_harness(1, UINT64_MAX, UINT64_MAX), S2N_ERR_INTEGER_OVERFLOW);
