...
int main(int argc, char **argv)
{
    ...
    /* Test s2n_psk_clone */
    {
        ...
        EXPECT_SUCCESS(s2n_psk_configure_early_data(original, test_early_data,
                s2n_tls13_aes_256_gcm_sha384.iana_value[0], s2n_tls13_aes_256_gcm_sha384.iana_value[1]));
