...
impl TestPair {
    ...
    pub unsafe extern "C" fn send_cb(context: *mut c_void, data: *const u8, len: u32) -> c_int {
    ...
    pub unsafe extern "C" fn recv_cb(context: *mut c_void, data: *mut u8, len: u32) -> c_int {
        let context = &*(context as *const LocalDataBuffer);
