...
static S2N_RESULT s2n_translate_protocol_error_to_alert(int error_code, uint8_t *alert)
{
    ...
    switch (error_code) {
        ...
        S2N_ALERT_CASE(S2N_ERR_CERT_UNTRUSTED, S2N_TLS_ALERT_BAD_CERTIFICATE);
        S2N_ALERT_CASE(S2N_ERR_CERT_VERIFY_HOST, S2N_TLS_ALERT_BAD_CERTIFICATE);
        ...
        S2N_ALERT_CASE(S2N_ERR_CERT_REJECTED, S2N_TLS_ALERT_CERTIFICATE_UNKNOWN);
