...
pkgs.stdenv.mkDerivation rec {
  ...
  src = pkgs.fetchzip {
    url =
      "https://github.com/openssl/openssl/archive/refs/tags/openssl-3.0.9.zip";
    sha256 = "sha256-ruOsPZO9znOE4l2gDPG56WMQG106CUxa5vDMQM4wb3I=";
  };
  ...
  configurePhase = ''
    ./Configure enable-fips shared -g3 -fPIC              \
